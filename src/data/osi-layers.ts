...
export const OSI_LAYERS: OsiLayer[] = [
  {
    ...
    receiverColor: { from: '#e0e7ff', to: '#c7d2fe' },
  },
  {
    level: 6, name: '表示层',
    ...
    receiverColor: { from: '#ede9fe', to: '#ddd6fe' },
  },
  {
    level: 5, name: '会话层',
    ...
    receiverColor: { from: '#f3e8ff', to: '#e9d5ff' },
  },
  {
    level: 4, name: '传输层',
    ...
    receiverColor: { from: '#dbeafe', to: '#bfdbfe' },
  },
  {
    level: 3, name: '网络层',
    ...
    receiverColor: { from: '#cffafe', to: '#a5f3fc' },
  },
  {
    level: 2, name: '数据链路层',
    ...
    receiverColor: { from: '#ccfbf1', to: '#99f6e4' },
  },
  {
    level: 1, name: '物理层',
    ...
    receiverColor: { from: '#d1fae5', to: '#6ee7b7' },
  },
]
